...
(function(a) {
    ...
    function J(a, b) {
        ...
        var d = 5;
        for (Gb.lastIndex = 0; d >= 0 && Gb.test(a);) a = a.replace(Gb, c),
            Gb.lastIndex = 0,
            d -= 1;
        return a
    }
    ...
    function R(a) {
        ...
        var b, c, d, e, f, g = F(a._l),
            ...
            i = h.length,
            j = 0;
        for (d = J(a._f, g).match(Fb) || [], b = 0; b < d.length; b++) e = d[b],
            c = (h.match(K(e, a)) || [])[0],
        c && (f = h.substr(0, h.indexOf(c)), f.length > 0 && a._pf.unusedInput.push(f), h = h.slice(h.indexOf(c) + c.length), j += c.length),
            hc[e] ? (c ? a._pf.empty = !1 : a._pf.unusedTokens.push(e), M(e, c, a)) : a._strict && !c && a._pf.unusedTokens.push(e);
    ...
    function U(a) {
        ...
        for (f = 0; f < a._f.length; f++) g = 0,
            ...
            b._f = a._f[f],
            R(b),
        A(b) && (g += b._pf.charsLeftOver, g += 10 * b._pf.unusedTokens.length, b._pf.score = g, (null == e || e > g) && (e = g, d = b));
        j(a, d || b)
    }
    function V(a) {
        var b, c, d = a._i,
    ...
    for (var mb, nb, ob, pb = "2.7.0",
             qb = "undefined" != typeof global ? global: this, rb = Math.round, sb = 0, tb = 1, ub = 2, vb = 3, wb = 4, xb = 5, yb = 6, zb = {},
             Ab = {
            ...
            Q: function() {
             ...
             ic = ["months", "monthsShort", "weekdays", "weekdaysShort", "weekdaysMin"]; fc.length;) ob = fc.pop(),
        hc[ob + "o"] = f(hc[ob], ob);
    for (; gc.length;) ob = gc.pop(),
        hc[ob + ob] = e(hc[ob], 2);
    for (hc.DDDD = e(hc.DDD, 3), j(g.prototype, {
        ...
        return "boolean" == typeof e && (f = e, e = a),
            ...
            db(g)
             ...
             mb.suppressDeprecationWarnings = !1, mb.createFromInputFallback = d("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to https://github.com/moment/moment/issues/1407 for more info.",
        function(a) {
            a._d = new Date(a._i)
        }), mb.min = function() {
        ...
        return eb("isBefore", a)
             ...
             mb.duration = function(a, b) {
                 ...
                 return mb.isDuration(a) ? f = {
                     ...
                     b ? f[b] = a: f.milliseconds = a) : (g = Db.exec(a)) ? (c = "-" === g[1] ? -1 : 1, f = {
                     y: 0,
                     d: u(g[ub]) * c,
                     h: u(g[vb]) * c,
                     m: u(g[wb]) * c,
    ...
    mb.normalizeUnits = function(a) {
        ...
        j(mb.fn = h.prototype, {
            ...
            min: d("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",
                function(a) {
    ...
    kb("Weeks", 6048e5),
        ...
        Bb ? module.exports = mb: "function" == typeof define && define.amd ? (define("moment",
            function(a, b, c) {
    ...
    return a.lang("zh-cn", {
        ...
        calendar: {
            ...
            nextWeek: function() {
                var b, c;
                b = a().startOf("week");
                c = this.unix() - b.unix() >= 7 * 24 * 3600 ? "[涓媇": "[鏈琞";
                return this.minutes() === 0 ? c + "dddAh鐐规暣": c + "dddAh鐐筸m"
            },
            lastWeek: function() {
                var b, c;
                b = a().startOf("week");
                c = this.unix() < b.unix() ? "[涓奭": "[鏈琞";
                return this.minutes() === 0 ? c + "dddAh鐐规暣": c + "dddAh鐐筸m"
            },
            sameElse: "LL"
        },
        ordinal: function(b, c) {
            switch (c) {
                case "d":
                case "D":
                case "DDD":
